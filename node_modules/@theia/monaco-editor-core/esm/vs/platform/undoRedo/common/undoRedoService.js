...
const extensions_1 = require("../../instantiation/common/extensions");
...
let UndoRedoService = class UndoRedoService {
    ...
    _confirmAndExecuteWorkspaceUndo(strResource, element, editStackSnapshot, undoConfirmed) {
        return __awaiter(this, void 0, void 0, function* () {
            if (element.canSplit() && !this._isPartOfUndoGroup(element)) {
                ...
                const result = yield this._dialogService.show(severity_1.default.Info, nls.localize('confirmWorkspace', "Would you like to undo '{0}' across all files?", element.label), [
    ...
    _confirmAndContinueUndo(strResource, sourceId, element) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield this._dialogService.show(severity_1.default.Info, nls.localize('confirmDifferentSource', "Would you like to undo '{0}'?", element.label), [
...
(0, extensions_1.registerSingleton)(undoRedo_1.IUndoRedoService, UndoRedoService);
