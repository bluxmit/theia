...
class SelectListRenderer {
    ...
    disposeTemplate(templateData) {
        templateData.disposables = (0, lifecycle_1.dispose)(templateData.disposables);
    }
}
class SelectBoxList extends lifecycle_1.Disposable {
    ...
    createSelectList(parent) {
        ...
        const onSelectDropDownKeyDown = event_2.Event.chain(onKeyDown.event)
    ...
    renderDescriptionMarkdown(text, actionHandler) {
        ...
        const rendered = (0, markdownRenderer_1.renderMarkdown)({ value: text }, { actionHandler });
