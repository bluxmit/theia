...
const listView_1 = require("../list/listView");
const abstractTree_1 = require("./abstractTree");
const indexTreeModel_1 = require("./indexTreeModel");
...
class AsyncDataTreeRenderer {
    ...
    renderTwistie(element, twistieElement) {
        if (element.slow) {
            twistieElement.classList.add(...codicons_1.Codicon.treeItemLoading.classNamesArray);
            return true;
        }
        else {
            twistieElement.classList.remove(...codicons_1.Codicon.treeItemLoading.classNamesArray);
            return false;
        }
    }
...
class AsyncDataTree {
    ...
    doGetChildren(node) {
        ...
        if ((0, types_1.isIterable)(children)) {
            ...
            result = (0, async_1.createCancelablePromise)(() => __awaiter(this, void 0, void 0, function* () { return this.processChildren(yield children); }));
