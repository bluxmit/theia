...
const inputBox_1 = require("../../../browser/ui/inputbox/inputBox");
...
class QuickInputBox extends lifecycle_1.Disposable {
    ...
    showDecoration(decoration) {
        if (decoration === severity_1.default.Ignore) {
            ...
            this.inputBox.showMessage({ type: decoration === severity_1.default.Info ? 1 /* MessageType.INFO */ : decoration === severity_1.default.Warning ? 2 /* MessageType.WARNING */ : 3 /* MessageType.ERROR */, content: '' });
        }
    }
    stylesForType(decoration) {
        return this.inputBox.stylesForType(decoration === severity_1.default.Info ? 1 /* MessageType.INFO */ : decoration === severity_1.default.Warning ? 2 /* MessageType.WARNING */ : 3 /* MessageType.ERROR */);
    }
    setFocus() {
        this.inputBox.focus();
    }
