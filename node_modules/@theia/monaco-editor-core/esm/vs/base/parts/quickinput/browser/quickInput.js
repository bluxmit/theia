...
const actionbar_1 = require("../../../browser/ui/actionbar/actionbar");
const button_1 = require("../../../browser/ui/button/button");
const countBadge_1 = require("../../../browser/ui/countBadge/countBadge");
const iconLabels_1 = require("../../../browser/ui/iconLabel/iconLabels");
const progressbar_1 = require("../../../browser/ui/progressbar/progressbar");
...
const quickInputUtils_1 = require("./quickInputUtils");
const quickInput_1 = require("../common/quickInput");
require("./media/quickInput.css");
const nls_1 = require("../../../../nls");
const quickInputBox_1 = require("./quickInputBox");
const quickInputList_1 = require("./quickInputList");
const $ = dom.$;
const backButton = {
    iconClass: codicons_1.Codicon.quickInputBack.classNames,
...
QuickInput.noPromptMessage = (0, nls_1.localize)('inputModeEntry', "Press 'Enter' to confirm your input or 'Escape' to cancel");
...
QuickPick.DEFAULT_ARIA_LABEL = (0, nls_1.localize)('quickInputBox.ariaLabel', "Type to narrow down results.");
...
class QuickInputController extends lifecycle_1.Disposable {
    ...
    getUI() {
        ...
        const visibleCount = new countBadge_1.CountBadge(visibleCountContainer, { countFormat: (0, nls_1.localize)({ key: 'quickInput.visibleCount', comment: ['This tells the user how many items are shown in a list of items to select from. The items can be anything. Currently not visible, but read by screen readers.'] }, "{0} Results") });
        const countContainer = dom.append(filterContainer, $('.quick-input-count'));
        countContainer.setAttribute('aria-live', 'polite');
        const count = new countBadge_1.CountBadge(countContainer, { countFormat: (0, nls_1.localize)({ key: 'quickInput.countSelected', comment: ['This tells the user how many items are selected in a list of items to select from. The items can be anything.'] }, "{0} Selected") });
    ...
    show(controller) {
        ...
        backButton.tooltip = backKeybindingLabel ? (0, nls_1.localize)('quickInput.backWithKeybinding', "Back ({0})", backKeybindingLabel) : (0, nls_1.localize)('quickInput.back', "Back");
        ...
        if (controller) {
            ...
            if (!focusChanged) {
                ...
                while (currentElement && !currentElement.offsetParent) {
                    currentElement = (0, types_1.withNullAsUndefined)(currentElement.parentElement);
                }
