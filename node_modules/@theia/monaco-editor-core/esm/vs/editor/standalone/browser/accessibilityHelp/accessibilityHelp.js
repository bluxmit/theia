...
const formattedTextRenderer_1 = require("../../../../base/browser/formattedTextRenderer");
...
const toggleTabFocusMode_1 = require("../../../contrib/toggleTabFocusMode/browser/toggleTabFocusMode");
...
let AccessibilityHelpWidget = class AccessibilityHelpWidget extends widget_1.Widget {
    constructor(editor, _contextKeyService, _keybindingService, _openerService) {
        ...
        this._register(dom.addStandardDisposableListener(this._contentDomNode.domNode, 'keydown', (e) => {
            ...
            if (e.equals(2048 /* KeyMod.CtrlCmd */ | 35 /* KeyCode.KeyE */)) {
                (0, aria_1.alert)(standaloneStrings_1.AccessibilityHelpNLS.emergencyConfOn);
    ...
    _buildContent() {
        ...
        if (options.get(54 /* EditorOption.inDiffEditor */)) {
        ...
        if (options.get(130 /* EditorOption.tabFocusMode */)) {
...
(0, editorExtensions_1.registerEditorAction)(ShowAccessibilityHelpAction);
