...
const viewLayer_1 = require("./viewLayer");
...
class ViewOverlayLine {
    constructor(configuration, dynamicOverlays) {
        ...
        this._lineHeight = this._configuration.options.get(59 /* EditorOption.lineHeight */);
...
class MarginViewOverlays extends ViewOverlays {
    constructor(context) {
        ...
        (0, domFontInfo_1.applyFontInfo)(this.domNode, options.get(44 /* EditorOption.fontInfo */));
    }
    onConfigurationChanged(e) {
        const options = this._context.configuration.options;
        (0, domFontInfo_1.applyFontInfo)(this.domNode, options.get(44 /* EditorOption.fontInfo */));
