...
const domFontInfo_1 = require("../config/domFontInfo");
...
const viewModel_1 = require("../../common/viewModel");
...
const diffReviewInsertIcon = (0, iconRegistry_1.registerIcon)('diff-review-insert', codicons_1.Codicon.add, nls.localize('diffReviewInsertIcon', 'Icon for \'Insert\' in diff review.'));
const diffReviewRemoveIcon = (0, iconRegistry_1.registerIcon)('diff-review-remove', codicons_1.Codicon.remove, nls.localize('diffReviewRemoveIcon', 'Icon for \'Remove\' in diff review.'));
const diffReviewCloseIcon = (0, iconRegistry_1.registerIcon)('diff-review-close', codicons_1.Codicon.close, nls.localize('diffReviewCloseIcon', 'Icon for \'Close\' in diff review.'));
let DiffReview = class DiffReview extends lifecycle_1.Disposable {
    constructor(diffEditor, _languageService) {
        ...
        this.shadow = (0, fastDomNode_1.createFastDomNode)(document.createElement('div'));
        this.shadow.setClassName('diff-review-shadow');
        this.actionBarContainer = (0, fastDomNode_1.createFastDomNode)(document.createElement('div'));
        ...
        this._actionBar.push(new actions_1.Action('diffreview.close', nls.localize('label.close', "Close"), 'close-diff-review ' + themeService_1.ThemeIcon.asClassName(diffReviewCloseIcon), true, () => __awaiter(this, void 0, void 0, function* () { return this.hide(); })), { label: false, icon: true });
        this.domNode = (0, fastDomNode_1.createFastDomNode)(document.createElement('div'));
        this.domNode.setClassName('diff-review monaco-editor-background');
        this._content = (0, fastDomNode_1.createFastDomNode)(document.createElement('div'));
    ...
    accept() {
        ...
        if (jumpToLineNumber !== -1) {
            ...
            this._diffEditor.revealPosition(new position_1.Position(jumpToLineNumber, 1), 1 /* ScrollType.Immediate */);
        }
    }
    hide() {
        this._isVisible = false;
    ...
    _render() {
        ...
        (0, domFontInfo_1.applyFontInfo)(container, modifiedOptions.get(44 /* EditorOption.fontInfo */));
        ...
        const lineHeight = modifiedOptions.get(59 /* EditorOption.lineHeight */);
    ...
    static _renderSection(dest, diffEntry, modLine, lineHeight, width, originalOptions, originalModel, originalModelOpts, modifiedOptions, modifiedModel, modifiedModelOpts, languageIdCodec) {
        ...
        const originalLayoutInfo = originalOptions.get(131 /* EditorOption.layoutInfo */);
        const originalLineNumbersWidth = originalLayoutInfo.glyphMarginWidth + originalLayoutInfo.lineNumbersWidth;
        const modifiedLayoutInfo = modifiedOptions.get(131 /* EditorOption.layoutInfo */);
        ...
        for (let i = 0; i <= cnt; i++) {
            ...
            if (spacerIcon) {
                ...
                spacerCodicon.className = themeService_1.ThemeIcon.asClassName(spacerIcon);
    ...
    static _renderLine(model, options, tabSize, lineNumber, languageIdCodec) {
        ...
        const r = (0, viewLineRenderer_1.renderViewLine2)(new viewLineRenderer_1.RenderLineInput((fontInfo.isMonospace && !options.get(29 /* EditorOption.disableMonospaceOptimizations */)), fontInfo.canUseHalfwidthRightwardsArrow, lineContent, false, isBasicASCII, containsRTL, 0, lineTokens, [], tabSize, 0, fontInfo.spaceWidth, fontInfo.middotWidth, fontInfo.wsmiddotWidth, options.get(105 /* EditorOption.stopRenderingLineAfter */), options.get(88 /* EditorOption.renderWhitespace */), options.get(83 /* EditorOption.renderControlCharacters */), options.get(45 /* EditorOption.fontLigatures */) !== editorOptions_1.EditorFontLigatures.OFF, null));
        return r.html;
    }
};
...
(0, editorExtensions_1.registerEditorAction)(DiffReviewNext);
(0, editorExtensions_1.registerEditorAction)(DiffReviewPrev);
