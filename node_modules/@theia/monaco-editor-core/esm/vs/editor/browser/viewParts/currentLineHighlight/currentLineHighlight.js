...
class AbstractLineHighlightOverlay extends dynamicViewOverlay_1.DynamicViewOverlay {
    constructor(context) {
        ...
        this._renderLineHighlight = options.get(85 /* EditorOption.renderLineHighlight */);
        this._renderLineHighlightOnlyWhenFocus = options.get(86 /* EditorOption.renderLineHighlightOnlyWhenFocus */);
