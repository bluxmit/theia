...
class Settings {
    constructor(config, theme) {
        ...
        this.pixelRatio = options.get(129 /* EditorOption.pixelRatio */);
        this.overviewRulerLanes = options.get(74 /* EditorOption.overviewRulerLanes */);
        this.renderBorder = options.get(73 /* EditorOption.overviewRulerBorder */);
        const borderColor = theme.getColor(editorColorRegistry_1.editorOverviewRulerBorder);
        this.borderColor = borderColor ? borderColor.toString() : null;
        this.hideCursor = options.get(52 /* EditorOption.hideCursorInOverviewRuler */);
        ...
        const backgroundColor = minimapEnabled
            ? theme.getColor(editorColorRegistry_1.editorOverviewRulerBackground) || languages_1.TokenizationRegistry.getDefaultBackground()
            : null;
...
class DecorationsOverviewRuler extends viewPart_1.ViewPart {
    ...
    _render() {
        ...
        decorations.sort(viewModel_1.OverviewRulerDecorationsGroup.cmp);
