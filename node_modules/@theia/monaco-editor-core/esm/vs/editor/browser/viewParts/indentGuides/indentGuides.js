...
const dynamicViewOverlay_1 = require("../../view/dynamicViewOverlay");
...
const guidesTextModelPart_1 = require("../../../common/model/guidesTextModelPart");
const textModelGuides_1 = require("../../../common/textModelGuides");
class IndentGuidesOverlay extends dynamicViewOverlay_1.DynamicViewOverlay {
    ...
    prepareRender(ctx) {
        ...
        for (let lineNumber = visibleStartLineNumber; lineNumber <= visibleEndLineNumber; lineNumber++) {
            ...
            let result = '';
            const leftOffset = (_b = (_a = ctx.visibleRangeForPosition(new position_1.Position(lineNumber, 1))) === null || _a === void 0 ? void 0 : _a.left) !== null && _b !== void 0 ? _b : 0;
            for (const guide of indent) {
                ...
                const width = guide.horizontalLine
                    ? ((_d = (_c = ctx.visibleRangeForPosition(new position_1.Position(lineNumber, guide.horizontalLine.endColumn))) === null || _c === void 0 ? void 0 : _c.left) !== null && _d !== void 0 ? _d : (left + this._spaceWidth)) - left
                    : this._spaceWidth;
        ...
        for (let lineNumber = visibleStartLineNumber; lineNumber <= visibleEndLineNumber; lineNumber++) {
            ...
            for (let indentLvl = 1; indentLvl <= indentGuidesInLine; indentLvl++) {
                ...
                if (!peeked || peeked.visibleColumn !== indentGuide || peeked.horizontalLine) {
                    lineGuides.push(new textModelGuides_1.IndentGuide(indentGuide, -1, isActive ? 'core-guide-indent-active' : 'core-guide-indent', null, -1, -1));
                }
            }
