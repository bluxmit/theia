...
class OverviewRuler extends viewEventHandler_1.ViewEventHandler {
    constructor(context, cssClassName) {
        ...
        this._zoneManager.setLineHeight(options.get(59 /* EditorOption.lineHeight */));
        this._zoneManager.setPixelRatio(options.get(129 /* EditorOption.pixelRatio */));
    ...
    onConfigurationChanged(e) {
        ...
        if (e.hasChanged(129 /* EditorOption.pixelRatio */)) {
            this._zoneManager.setPixelRatio(options.get(129 /* EditorOption.pixelRatio */));
