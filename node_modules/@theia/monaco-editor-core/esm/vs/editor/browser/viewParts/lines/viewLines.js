...
const viewLayer_1 = require("../../view/viewLayer");
...
class ViewLines extends viewPart_1.ViewPart {
    constructor(context, linesContent) {
        ...
        this._revealHorizontalRightPadding = options.get(89 /* EditorOption.revealHorizontalRightPadding */);
    ...
    linesVisibleRangesForRange(_range, includeNewLines) {
        ...
        for (let lineNumber = range.startLineNumber; lineNumber <= range.endLineNumber; lineNumber++) {
            ...
            visibleRanges[visibleRangesLen++] = new renderingContext_1.LineVisibleRanges(visibleRangesForLine.outsideRenderedLine, lineNumber, renderingContext_1.HorizontalRange.from(visibleRangesForLine.ranges));
        }
    ...
    _visibleRangesForLineRange(lineNumber, startColumn, endColumn) {
        ...
        return this._visibleLines.getVisibleLine(lineNumber).getVisibleRangesForRange(lineNumber, startColumn, endColumn, new viewLine_1.DomReadingContext(this.domNode.domNode, this._textRangeRestingSpot));
    }
