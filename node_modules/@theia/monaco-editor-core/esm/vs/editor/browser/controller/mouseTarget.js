...
const viewLine_1 = require("../viewParts/lines/viewLine");
const position_1 = require("../../common/core/position");
const range_1 = require("../../common/core/range");
const cursorColumns_1 = require("../../common/core/cursorColumns");
const dom = require("../../../base/browser/dom");
const cursorAtomicMoveOperations_1 = require("../../common/cursor/cursorAtomicMoveOperations");
...
class HitTestContext {
    constructor(context, viewHelper, lastRenderData) {
        ...
        this.layoutInfo = options.get(131 /* EditorOption.layoutInfo */);
        ...
        this.typicalHalfwidthCharacterWidth = options.get(44 /* EditorOption.fontInfo */).typicalHalfwidthCharacterWidth;
...
class MouseTargetFactory {
    ...
    getMouseColumn(relativePos) {
        ...
        return MouseTargetFactory._getMouseColumn(mouseContentHorizontalOffset, options.get(44 /* EditorOption.fontInfo */).typicalHalfwidthCharacterWidth);
    }
