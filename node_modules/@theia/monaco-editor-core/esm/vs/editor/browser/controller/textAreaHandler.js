...
const textAreaState_1 = require("./textAreaState");
...
const wordCharacterClassifier_1 = require("../../common/core/wordCharacterClassifier");
...
const mouseCursor_1 = require("../../../base/browser/ui/mouseCursor/mouseCursor");
...
class TextAreaHandler extends viewPart_1.ViewPart {
    constructor(context, viewController, visibleRangeProvider) {
        ...
        this._fontInfo = options.get(44 /* EditorOption.fontInfo */);
        this._lineHeight = options.get(59 /* EditorOption.lineHeight */);
        this._emptySelectionClipboard = options.get(32 /* EditorOption.emptySelectionClipboard */);
        ...
        this.textArea.setAttribute('tabindex', String(options.get(112 /* EditorOption.tabIndex */)));
        this.textArea.setAttribute('role', 'textbox');
        this.textArea.setAttribute('aria-roledescription', nls.localize('editor', "editor"));
        this.textArea.setAttribute('aria-multiline', 'true');
        this.textArea.setAttribute('aria-haspopup', 'false');
        this.textArea.setAttribute('aria-autocomplete', 'both');
        if (options.get(30 /* EditorOption.domReadOnly */) && options.get(81 /* EditorOption.readOnly */)) {
            ...
            getScreenReaderContent: (currentState) => {
                if (this._accessibilitySupport === 1 /* AccessibilitySupport.Disabled */) {
                    ...
                    if (browser.isSafari && !selection.isEmpty()) {
                        ...
                        return new textAreaState_1.TextAreaState(placeholderText, 0, placeholderText.length, null, null);
                    }
                ...
                if (browser.isAndroid) {
                    ...
                    if (selection.isEmpty()) {
                        ...
                        if (wordAtPosition.length > 0) {
                            return new textAreaState_1.TextAreaState(wordAtPosition, positionOffsetInWord, positionOffsetInWord, position, position);
                        }
                    }
                    return textAreaState_1.TextAreaState.EMPTY;
                }
                return textAreaState_1.PagedScreenReaderStrategy.fromEditorSelection(currentState, simpleModel, this._selections[0], this._accessibilityPageSize, this._accessibilitySupport === 0 /* AccessibilitySupport.Unknown */);
            },
        ...
        this._textAreaInput = this._register(new textAreaInput_1.TextAreaInput(textAreaInputHost, textAreaWrapper, platform.OS, browser));
    ...
    _getWordBeforePosition(position) {
        const lineContent = this._context.viewModel.getLineContent(position.lineNumber);
        const wordSeparators = (0, wordCharacterClassifier_1.getMapForWordSeparators)(this._context.configuration.options.get(117 /* EditorOption.wordSeparators */));
    ...
    onConfigurationChanged(e) {
        ...
        this.textArea.setAttribute('aria-label', this._getAriaLabel(options));
        this.textArea.setAttribute('tabindex', String(options.get(112 /* EditorOption.tabIndex */)));
        if (e.hasChanged(30 /* EditorOption.domReadOnly */) || e.hasChanged(81 /* EditorOption.readOnly */)) {
            if (options.get(30 /* EditorOption.domReadOnly */) && options.get(81 /* EditorOption.readOnly */)) {
                this.textArea.setAttribute('readonly', 'true');
            }
            else {
    ...
    _doRender(renderData) {
        ...
        const options = this._context.configuration.options;
        if (options.get(50 /* EditorOption.glyphMargin */)) {
            tac.setClassName('monaco-editor-background textAreaCover ' + margin_1.Margin.OUTER_CLASS_NAME);
        }
        else {
            if (options.get(60 /* EditorOption.lineNumbers */).renderType !== 0 /* RenderLineNumbersType.Off */) {
