...
exports.TextAreaWrapper = exports.TextAreaInput = exports.InMemoryClipboardMetadataManager = exports.CopyOptions = exports.TextAreaSyntethicEvents = void 0;
...
class TextAreaWrapper extends lifecycle_1.Disposable {
    constructor(_actual) {
        ...
        this.onKeyPress = this._register(dom.createEventEmitter(this._actual, 'keypress')).event;
        ...
        this.onBeforeInput = this._register(dom.createEventEmitter(this._actual, 'beforeinput')).event;
        ...
        this._onSyntheticTap = this._register(new event_1.Emitter());
