...
const mouseTarget_1 = require("./mouseTarget");
const editorDom_1 = require("../editorDom");
...
class MouseHandler extends viewEventHandler_1.ViewEventHandler {
    constructor(context, viewController, viewHelper) {
        ...
        this._height = this._context.configuration.options.get(131 /* EditorOption.layoutInfo */).height;
        ...
        const onMouseWheel = (browserEvent) => {
            ...
            if (!this._context.configuration.options.get(68 /* EditorOption.mouseWheelZoom */)) {
                return;
            }
    ...
    onConfigurationChanged(e) {
        if (e.hasChanged(131 /* EditorOption.layoutInfo */)) {
            // layout change
            const height = this._context.configuration.options.get(131 /* EditorOption.layoutInfo */).height;
    ...
    _onMouseDown(e, pointerId) {
        ...
        const selectOnLineNumbers = this._context.configuration.options.get(98 /* EditorOption.selectOnLineNumbers */);
...
class MouseDownOperation extends lifecycle_1.Disposable {
    ...
    start(targetType, e, pointerId) {
        ...
        if (!options.get(81 /* EditorOption.readOnly */)
            ...
            this._isActive = true;
            this._mouseMoveMonitor.startMonitoring(this._viewHelper.viewLinesDomNode, pointerId, e.buttons, createMouseMoveEventMerger(null), (e) => this._onMouseDownThenMove(e), (browserEvent) => {
        ...
        if (!this._isActive) {
            this._isActive = true;
            this._mouseMoveMonitor.startMonitoring(this._viewHelper.viewLinesDomNode, pointerId, e.buttons, createMouseMoveEventMerger(null), (e) => this._onMouseDownThenMove(e), () => this._stop());
        }
    }
    _stop() {
        this._isActive = false;
    ...
    _getPositionOutsideEditor(e) {
        ...
        if (e.posy < editorContent.y) {
            ...
            if (viewZoneData) {
                ...
                if (newPosition) {
                    return mouseTarget_1.MouseTarget.createOutsideEditor(mouseColumn, newPosition);
                }
            }
            const aboveLineNumber = viewLayout.getLineNumberAtVerticalOffset(verticalOffset);
            return mouseTarget_1.MouseTarget.createOutsideEditor(mouseColumn, new position_1.Position(aboveLineNumber, 1));
        }
        if (e.posy > editorContent.y + editorContent.height) {
            ...
            return mouseTarget_1.MouseTarget.createOutsideEditor(mouseColumn, new position_1.Position(belowLineNumber, model.getLineMaxColumn(belowLineNumber)));
        }
        const possibleLineNumber = viewLayout.getLineNumberAtVerticalOffset(viewLayout.getCurrentScrollTop() + e.relativePos.y);
        if (e.posx < editorContent.x) {
            return mouseTarget_1.MouseTarget.createOutsideEditor(mouseColumn, new position_1.Position(possibleLineNumber, 1));
        }
        if (e.posx > editorContent.x + editorContent.width) {
            return mouseTarget_1.MouseTarget.createOutsideEditor(mouseColumn, new position_1.Position(possibleLineNumber, model.getLineMaxColumn(possibleLineNumber)));
        }
        return null;
    }
