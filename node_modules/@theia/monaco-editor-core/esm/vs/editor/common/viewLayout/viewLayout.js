...
const linesLayout_1 = require("./linesLayout");
...
class ViewLayout extends lifecycle_1.Disposable {
    constructor(configuration, lineCount, scheduleAtNextAnimationFrame) {
        ...
        const padding = options.get(75 /* EditorOption.padding */);
        this._linesLayout = new linesLayout_1.LinesLayout(lineCount, options.get(59 /* EditorOption.lineHeight */), padding.top, padding.bottom);
    ...
    _configureSmoothScrollDuration() {
        this._scrollable.setSmoothScrollDuration(this._configuration.options.get(103 /* EditorOption.smoothScrolling */) ? SMOOTH_SCROLLING_TIME : 0);
    }
    // ---- begin view event handlers
    onConfigurationChanged(e) {
        const options = this._configuration.options;
        if (e.hasChanged(59 /* EditorOption.lineHeight */)) {
            this._linesLayout.setLineHeight(options.get(59 /* EditorOption.lineHeight */));
        }
        if (e.hasChanged(75 /* EditorOption.padding */)) {
            const padding = options.get(75 /* EditorOption.padding */);
        ...
        if (e.hasChanged(103 /* EditorOption.smoothScrolling */)) {
            this._configureSmoothScrollDuration();
        }
    }
    onFlushed(lineCount) {
    ...
    _getContentHeight(width, height, contentWidth) {
        ...
        if (options.get(94 /* EditorOption.scrollBeyondLastLine */)) {
            result += Math.max(0, height - options.get(59 /* EditorOption.lineHeight */) - options.get(75 /* EditorOption.padding */).bottom);
        }
        else {
    ...
    _computeContentWidth(maxLineWidth) {
        ...
        if (wrappingInfo.isViewportWrapping) {
            ...
            const extraHorizontalSpace = options.get(93 /* EditorOption.scrollBeyondLastColumn */) * fontInfo.typicalHalfwidthCharacterWidth;
