...
class TokenizationTextModelPart extends textModelPart_1.TextModelPart {
    constructor(_languageService, _languageConfigurationService, _textModel, bracketPairsTextModelPart, _languageId) {
        ...
        this._onBackgroundTokenizationStateChanged = this._register(new event_1.Emitter());
        this.onBackgroundTokenizationStateChanged = this._onBackgroundTokenizationStateChanged.event;
        this._tokens = new contiguousTokensStore_1.ContiguousTokensStore(this._languageService.languageIdCodec);
        this._semanticTokens = new sparseTokensStore_1.SparseTokensStore(this._languageService.languageIdCodec);
        this._tokenization = new textModelTokens_1.TextModelTokenization(_textModel, this, this._languageService.languageIdCodec);
    ...
    setLineTokens(lineNumber, tokens) {
        ...
        this._tokens.setTokens(this._languageId, lineNumber - 1, this._textModel.getLineLength(lineNumber), tokens, false);
    }
