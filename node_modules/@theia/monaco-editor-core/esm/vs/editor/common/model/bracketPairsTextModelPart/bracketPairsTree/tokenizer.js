...
class TextBufferTokenizer {
    ...
    get length() {
        return (0, length_1.toLength)(this.textBufferLineCount, this.textBufferLastLineLength);
    }
    getText() {
    ...
    read() {
        ...
        while (true) {
            ...
            if (this.lineTokenOffset < tokenCount) {
                ...
                const isOther = languages_1.TokenMetadata.getTokenType(tokenMetadata) === 0 /* StandardTokenType.Other */;
                const containsBracketType = languages_1.TokenMetadata.containsBalancedBrackets(tokenMetadata);
