...
exports.DidChangeContentEmitter = exports.DidChangeDecorationsEmitter = exports.ModelDecorationOptions = exports.ModelDecorationInjectedTextOptions = exports.ModelDecorationMinimapOptions = exports.ModelDecorationOverviewRulerOptions = exports.TextModel = exports.LONG_LINE_BOUNDARY = exports.createTextBuffer = exports.createTextBufferFactoryFromSnapshot = exports.createTextBufferFactoryFromStream = exports.createTextBufferFactory = void 0;
...
const indentation_1 = require("../core/indentation");
const position_1 = require("../core/position");
const range_1 = require("../core/range");
const selection_1 = require("../core/selection");
const textModelDefaults_1 = require("../core/textModelDefaults");
const language_1 = require("../languages/language");
const languageConfigurationRegistry_1 = require("../languages/languageConfigurationRegistry");
const model = require("../model");
const bracketPairsImpl_1 = require("./bracketPairsTextModelPart/bracketPairsImpl");
const colorizedBracketPairsDecorationProvider_1 = require("./bracketPairsTextModelPart/colorizedBracketPairsDecorationProvider");
const editStack_1 = require("./editStack");
const guidesTextModelPart_1 = require("./guidesTextModelPart");
const indentationGuesser_1 = require("./indentationGuesser");
const intervalTree_1 = require("./intervalTree");
const pieceTreeTextBuffer_1 = require("./pieceTreeTextBuffer/pieceTreeTextBuffer");
const pieceTreeTextBufferBuilder_1 = require("./pieceTreeTextBuffer/pieceTreeTextBufferBuilder");
const textModelSearch_1 = require("./textModelSearch");
const tokenizationTextModelPart_1 = require("./tokenizationTextModelPart");
const textModelEvents_1 = require("../textModelEvents");
const undoRedo_1 = require("../../../platform/undoRedo/common/undoRedo");
...
let TextModel = class TextModel extends lifecycle_1.Disposable {
    constructor(source, languageId, creationOptions, associatedResource = null, _undoRedoService, _languageService, _languageConfigurationService) {
        ...
        this._tokenizationTextModelPart = new tokenizationTextModelPart_1.TokenizationTextModelPart(this._languageService, this._languageConfigurationService, this, this._bracketPairs, languageId);
    ...
    _doApplyEdits(rawOperations, computeUndoEdits) {
        ...
        if (contentChanges.length !== 0) {
            ...
            for (let i = 0, len = contentChanges.length; i < len; i++) {
                ...
                const [eolCount, firstLineLength, lastLineLength] = (0, eolCounter_1.countEOL)(change.text);
    ...
    getDecorationsInRange(range, ownerId = 0, filterOutValidation = false) {
        ...
        (0, arrays_1.pushMany)(decorations, this._decorationProvider.getDecorationsInRange(validatedRange, ownerId, filterOutValidation));
        return decorations;
    }
