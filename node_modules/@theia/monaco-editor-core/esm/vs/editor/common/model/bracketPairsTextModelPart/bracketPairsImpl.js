...
const bracketPairsTree_1 = require("./bracketPairsTree/bracketPairsTree");
const supports_1 = require("../../languages/supports");
const richEditBrackets_1 = require("../../languages/supports/richEditBrackets");
    ...
    */
    ...
    findMatchingBracketUp(_bracket, _position, maxDuration) {
        ...
        if (this.canBuildAST) {
            ...
            const bracketPair = (0, arrays_1.findLast)(this.getBracketPairsInRange(range_1.Range.fromPositions(_position, _position)) || [], (b) => closingBracketInfo.closes(b.openingBracketInfo));
            if (bracketPair) {
    ...
    matchBracket(position, maxDuration) {
        if (this.canBuildAST) {
            const bracketPair = (0, arrays_1.findLastMaxBy)(this.getBracketPairsInRange(range_1.Range.fromPositions(position, position)).filter((item) => item.closingBracketRange !== undefined &&
                (item.openingBracketRange.containsPosition(position) ||
                    item.closingBracketRange.containsPosition(position))), (0, arrays_1.compareBy)((item) => item.openingBracketRange.containsPosition(position)
    ...
    findEnclosingBrackets(_position, maxDuration) {
        ...
        if (this.canBuildAST) {
            ...
            const bracketPair = (0, arrays_1.findLast)(this.getBracketPairsInRange(range_1.Range.fromPositions(position, position)), (item) => item.closingBracketRange !== undefined && item.range.strictContainsRange(range));
            if (bracketPair) {
                return [bracketPair.openingBracketRange, bracketPair.closingBracketRange];
            }
            return null;
