...
const textModelGuides_1 = require("../textModelGuides");
class GuidesTextModelPart extends textModelPart_1.TextModelPart {
    ...
    getLinesBracketGuides(startLineNumber, endLineNumber, activePosition, options) {
        ...
        const bracketPairs = this.textModel.bracketPairs.getBracketPairsInRangeWithMinIndentation(new range_1.Range(startLineNumber, 1, endLineNumber, this.textModel.getLineMaxColumn(endLineNumber)));
        ...
        if (activePosition && bracketPairs.length > 0) {
            const bracketsContainingActivePosition = (startLineNumber <= activePosition.lineNumber &&
                ...
                ? bracketPairs
                : this.textModel.bracketPairs.getBracketPairsInRange(range_1.Range.fromPositions(activePosition))).filter((bp) => range_1.Range.strictContainsPosition(bp.range, activePosition));
            activeBracketPairRange = (_a = (0, arrays_1.findLast)(bracketsContainingActivePosition, (i) => includeSingleLinePairs || i.range.startLineNumber !== i.range.endLineNumber)) === null || _a === void 0 ? void 0 : _a.range;
        }
