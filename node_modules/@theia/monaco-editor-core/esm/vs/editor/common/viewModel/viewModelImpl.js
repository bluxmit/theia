...
const editorOptions_1 = require("../config/editorOptions");
const cursor_1 = require("../cursor/cursor");
const cursorCommon_1 = require("../cursorCommon");
const position_1 = require("../core/position");
const range_1 = require("../core/range");
const textModelEvents = require("../textModelEvents");
const languages_1 = require("../languages");
const modesRegistry_1 = require("../languages/modesRegistry");
const textToHtmlTokenizer_1 = require("../languages/textToHtmlTokenizer");
const viewEvents = require("../viewEvents");
const viewLayout_1 = require("../viewLayout/viewLayout");
const minimapTokensColorTracker_1 = require("./minimapTokensColorTracker");
const viewModel_1 = require("../viewModel");
const viewModelDecorations_1 = require("./viewModelDecorations");
const viewModelEventDispatcher_1 = require("../viewModelEventDispatcher");
const viewModelLines_1 = require("./viewModelLines");
...
class ViewModel extends lifecycle_1.Disposable {
    constructor(editorId, configuration, model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, scheduleAtNextAnimationFrame, languageConfigurationService, _themeService) {
        ...
        if (USE_IDENTITY_LINES_COLLECTION && this.model.isTooLargeForTokenization()) {
            ...
            const wrappingStrategy = options.get(125 /* EditorOption.wrappingStrategy */);
            const wrappingInfo = options.get(132 /* EditorOption.wrappingInfo */);
            const wrappingIndent = options.get(124 /* EditorOption.wrappingIndent */);
            this._lines = new viewModelLines_1.ViewModelLinesFromProjectedModel(this._editorId, this.model, domLineBreaksComputerFactory, monospaceLineBreaksComputerFactory, fontInfo, this.model.getOptions().tabSize, wrappingStrategy, wrappingInfo.wrappingColumn, wrappingIndent);
        }
    ...
    dispose() {
        ...
        this._lines.dispose();
        this._viewportStartLineTrackedRange = this.model._setTrackedRange(this._viewportStartLineTrackedRange, null, 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */);
    ...
    _onConfigurationChanged(eventsCollector, e) {
        ...
        if (this._viewportStartLine !== -1) {
            const previousViewportStartViewPosition = new position_1.Position(this._viewportStartLine, this.getLineMinColumn(this._viewportStartLine));
        ...
        if (e.hasChanged(81 /* EditorOption.readOnly */)) {
        ...
        if (restorePreviousViewportStart && previousViewportStartModelPosition) {
            ...
            this.viewLayout.setScrollPosition({ scrollTop: viewPositionTop + this._viewportStartLineDelta }, 1 /* ScrollType.Immediate */);
        }
    ...
    getVisibleRangesPlusViewportAboveBelow() {
        const layoutInfo = this._configuration.options.get(131 /* EditorOption.layoutInfo */);
        const lineHeight = this._configuration.options.get(59 /* EditorOption.lineHeight */);
    ...
    setViewport(startLineNumber, endLineNumber, centeredLineNumber) {
        ...
        const position = this.coordinatesConverter.convertViewPositionToModelPosition(new position_1.Position(startLineNumber, this.getLineMinColumn(startLineNumber)));
        this._viewportStartLineTrackedRange = this.model._setTrackedRange(this._viewportStartLineTrackedRange, new range_1.Range(position.lineNumber, position.column, position.lineNumber, position.column), 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */);
    ...
    getRichTextToCopy(modelRanges, emptySelectionClipboard) {
        ...
        const fontInfo = this._configuration.options.get(44 /* EditorOption.fontInfo */);
