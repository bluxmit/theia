...
const modelLineProjectionData_1 = require("../modelLineProjectionData");
class MonospaceLineBreaksComputerFactory {
    constructor(breakBeforeChars, breakAfterChars) {
        this.classifier = new WrappingCharacterClassifier(breakBeforeChars, breakAfterChars);
    }
    static create(options) {
        return new MonospaceLineBreaksComputerFactory(options.get(120 /* EditorOption.wordWrapBreakBeforeCharacters */), options.get(119 /* EditorOption.wordWrapBreakAfterCharacters */));
    }
...
function canBreak(prevCharCode, prevCharCodeClass, charCode, charCodeClass) {
    return (charCode !== 32 /* CharCode.Space */
        && ((prevCharCodeClass === 2 /* CharacterClass.BREAK_AFTER */)
            ...
            || (charCodeClass === 1 /* CharacterClass.BREAK_BEFORE */)
