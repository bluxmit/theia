...
const sparseMultilineTokens_1 = require("../tokens/sparseMultilineTokens");
    ...
    getMetadata(tokenTypeIndex, tokenModifierSet, languageId) {
        ...
        if (entry) {
            ...
            if (this._logService.getLevel() === log_1.LogLevel.Trace) {
                this._logService.trace(`SemanticTokensProviderStyling [CACHED] ${tokenTypeIndex} / ${tokenModifierSet}: foreground ${languages_1.TokenMetadata.getForeground(metadata)}, fontStyle ${languages_1.TokenMetadata.getFontStyle(metadata).toString(2)}`);
            }
        }
        else {
            ...
            if (this._logService.getLevel() === log_1.LogLevel.Trace) {
                this._logService.trace(`SemanticTokensProviderStyling ${tokenTypeIndex} (${tokenType}) / ${tokenModifierSet} (${tokenModifiers.join(' ')}): foreground ${languages_1.TokenMetadata.getForeground(metadata)}, fontStyle ${languages_1.TokenMetadata.getFontStyle(metadata).toString(2)}`);
            }
        }
        return metadata;
    }
