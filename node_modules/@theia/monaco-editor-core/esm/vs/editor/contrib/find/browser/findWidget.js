...
const toggle_1 = require("../../../../base/browser/ui/toggle/toggle");
...
class FindWidget extends widget_1.Widget {
    constructor(codeEditor, controller, state, contextViewProvider, keybindingService, contextKeyService, themeService, storageService, notificationService) {
        ...
        this._ctrlEnterReplaceAllWarningPrompted = !!storageService.getBoolean(ctrlEnterReplaceAllWarningPromptedKey, 0 /* StorageScope.GLOBAL */);
        ...
        this._register(this._codeEditor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(81 /* EditorOption.readOnly */)) {
                if (this._codeEditor.getOption(81 /* EditorOption.readOnly */)) {
            ...
            if (e.hasChanged(35 /* EditorOption.find */)) {
                const addExtraSpaceOnTop = this._codeEditor.getOption(35 /* EditorOption.find */).addExtraSpaceOnTop;
        ...
        if (this._codeEditor.getOption(35 /* EditorOption.find */).addExtraSpaceOnTop) {
    ...
    _onStateChanged(e) {
        ...
        if (e.isReplaceRevealed) {
            if (this._state.isReplaceRevealed) {
                if (!this._codeEditor.getOption(81 /* EditorOption.readOnly */) && !this._isReplaceVisible) {
    ...
    _updateButtons() {
        ...
        let canReplace = !this._codeEditor.getOption(81 /* EditorOption.readOnly */);
    ...
    _reveal() {
        ...
        if (!this._isVisible) {
            ...
            switch (this._codeEditor.getOption(35 /* EditorOption.find */).autoFindInSelection) {
                case 'always':
                    this._toggleSelectionFind.checked = true;
                    break;
                case 'never':
            ...
            if (this._codeEditor.getOption(35 /* EditorOption.find */).seedSearchStringFromSelection && selection) {
    ...
    _showViewZone(adjustScroll = true) {
        ...
        this._codeEditor.changeViewZones((accessor) => {
            if (this._viewZoneId !== undefined) {
                ...
                scrollAdjustment -= this._codeEditor.getOption(75 /* EditorOption.padding */).top;
        ...
        if (e.equals(ctrlKeyMod | 3 /* KeyCode.Enter */)) {
            if (this._keybindingService.dispatchEvent(e, e.target)) {
                ...
                if (platform.isWindows && platform.isNative && !this._ctrlEnterReplaceAllWarningPrompted) {
                    ...
                    this._storageService.store(ctrlEnterReplaceAllWarningPromptedKey, true, 0 /* StorageScope.GLOBAL */, 0 /* StorageTarget.USER */);
                }
