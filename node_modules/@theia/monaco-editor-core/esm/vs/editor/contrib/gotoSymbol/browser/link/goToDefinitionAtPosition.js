...
const clickLinkGesture_1 = require("./clickLinkGesture");
...
const goToCommands_1 = require("../goToCommands");
...
let GotoDefinitionAtPositionEditorContribution = class GotoDefinitionAtPositionEditorContribution {
    constructor(editor, textModelResolverService, languageService, languageFeaturesService) {
        ...
        this.toUnhook.add(linkGesture.onMouseMoveOrRelevantKeyDown(([mouseEvent, keyboardEvent]) => {
            this.startFindDefinitionFromMouse(mouseEvent, (0, types_1.withNullAsUndefined)(keyboardEvent));
        }));
    ...
    startFindDefinition(position) {
        ...
        let state = new editorState_1.EditorState(this.editor, 4 /* CodeEditorStateFlag.Position */ | 1 /* CodeEditorStateFlag.Value */ | 2 /* CodeEditorStateFlag.Selection */ | 8 /* CodeEditorStateFlag.Scroll */);
        ...
        return this.previousPromise.then(results => {
            ...
            // Single result
                ...
                this.textModelResolverService.createModelReference(result.uri).then(ref => {
                    ...
                    this.addDecoration(wordRange, new htmlContent_1.MarkdownString().appendCodeblock(languageId ? languageId : '', previewValue));
                    ref.dispose();
                });
            }
    ...
    gotoDefinition(position, openToSide) {
        ...
        return this.editor.invokeWithinContext((accessor) => {
            const canPeek = !openToSide && this.editor.getOption(78 /* EditorOption.definitionLinkOpensInPeek */) && !this.isInPeekEditor(accessor);
...
(0, editorExtensions_1.registerEditorContribution)(GotoDefinitionAtPositionEditorContribution.ID, GotoDefinitionAtPositionEditorContribution);
