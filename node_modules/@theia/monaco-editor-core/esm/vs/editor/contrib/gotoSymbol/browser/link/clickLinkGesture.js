...
class ClickLinkGesture extends lifecycle_1.Disposable {
    constructor(editor) {
        ...
        this._editor = editor;
        this._opts = createOptions(this._editor.getOption(70 /* EditorOption.multiCursorModifier */));
        this._lastMouseMoveEvent = null;
        this._hasTriggerKeyOnMouseDown = false;
        this._lineNumberOnMouseDown = 0;
        this._register(this._editor.onDidChangeConfiguration((e) => {
            if (e.hasChanged(70 /* EditorOption.multiCursorModifier */)) {
                const newOpts = createOptions(this._editor.getOption(70 /* EditorOption.multiCursorModifier */));
