...
const hoverWidget_1 = require("../../../../base/browser/ui/hover/hoverWidget");
...
const hoverOperation_1 = require("./hoverOperation");
...
let ContentHoverController = class ContentHoverController extends lifecycle_1.Disposable {
    ...
    maybeShowAt(mouseEvent) {
        ...
        if (target.type === 7 /* MouseTargetType.CONTENT_EMPTY */) {
            const epsilon = this._editor.getOption(44 /* EditorOption.fontInfo */).typicalHalfwidthCharacterWidth / 2;
 ...
 */
class EditorDecorationsChangerListener extends lifecycle_1.Disposable {
    constructor(_editor) {
        super();
        this._editor = _editor;
...
let ContentHoverWidget = class ContentHoverWidget extends lifecycle_1.Disposable {
    ...
    _layout() {
        ...
        const { fontSize, lineHeight } = this._editor.getOption(44 /* EditorOption.fontInfo */);
