...
const globalPointerMoveMonitor_1 = require("../../../../base/browser/globalPointerMoveMonitor");
...
class SaturationBox extends lifecycle_1.Disposable {
    ...
    onPointerDown(e) {
        ...
        this.monitor.startMonitoring(e.target, e.pointerId, e.buttons, globalPointerMoveMonitor_1.standardPointerMoveMerger, event => this.onDidChangePosition(event.pageX - origin.left, event.pageY - origin.top), () => null);
...
class Strip extends lifecycle_1.Disposable {
    ...
    onPointerDown(e) {
        ...
        monitor.startMonitoring(e.target, e.pointerId, e.buttons, globalPointerMoveMonitor_1.standardPointerMoveMerger, event => this.onDidChangeTop(event.pageY - origin.top), () => null);
        const pointerUpListener = dom.addDisposableListener(document, dom.EventType.POINTER_UP, () => {
            this._onColorFlushed.fire();
            pointerUpListener.dispose();
