...
exports.ColorDetector = exports.ColorDecorationInjectedTextMarker = void 0;
...
let ColorDetector = class ColorDetector extends lifecycle_1.Disposable {
    ...
    beginCompute() {
        this._computePromise = (0, async_1.createCancelablePromise)((token) => __awaiter(this, void 0, void 0, function* () {
            const model = this._editor.getModel();
            if (!model) {
                return Promise.resolve([]);
            }
            const sw = new stopwatch_1.StopWatch(false);
            const colors = yield (0, color_2.getColors)(this._languageFeaturesService.colorProvider, model, token);
...
(0, editorExtensions_1.registerEditorContribution)(ColorDetector.ID, ColorDetector);
