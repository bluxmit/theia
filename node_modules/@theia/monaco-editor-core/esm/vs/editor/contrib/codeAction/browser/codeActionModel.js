    ...
    _onMarkerChanges(resources) {
        ...
        if (resources.some(resource => (0, resources_1.isEqual)(resource, model.uri))) {
            this._autoTriggerTimer.cancelAndSet(() => {
                this.trigger({ type: 2 /* CodeActionTriggerType.Auto */ });
            }, this._delay);
        }
    }
    _onCursorChange() {
...
class CodeActionModel extends lifecycle_1.Disposable {
    ...
    _update() {
        ...
        if (model
            ...
            && !this._editor.getOption(81 /* EditorOption.readOnly */)) {
            ...
            this._codeActionOracle.value.trigger({ type: 2 /* CodeActionTriggerType.Auto */ });
        }
        else {
