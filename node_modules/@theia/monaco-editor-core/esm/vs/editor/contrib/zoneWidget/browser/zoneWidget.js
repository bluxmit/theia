...
class Arrow {
    ...
    show(where) {
        ...
        this._decorations = this._editor.deltaDecorations(this._decorations, [{ range: range_1.Range.fromPositions(where), options: { description: 'zone-widget-arrow', className: this._ruleName, stickiness: 1 /* TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges */ } }]);
    }
    hide() {
...
class ZoneWidget {
    ...
    _decoratingElementsHeight() {
        let lineHeight = this.editor.getOption(59 /* EditorOption.lineHeight */);
        let result = 0;
        if (this.options.showArrow) {
    ...
    _showImpl(where, heightInLines) {
        ...
        const lineHeight = this.editor.getOption(59 /* EditorOption.lineHeight */);
    ...
    _initSash() {
        ...
        this._disposables.add(this._resizeSash.onDidChange((evt) => {
            if (data) {
                let lineDelta = (evt.currentY - data.startY) / this.editor.getOption(59 /* EditorOption.lineHeight */);
