...
let WordContextKey = class WordContextKey {
    constructor(_editor, contextKeyService) {
        ...
        this._configListener = this._editor.onDidChangeConfiguration(e => e.hasChanged(111 /* EditorOption.tabCompletion */) && this._update());
        this._update();
    }
    dispose() {
        var _a;
    ...
    _update() {
        ...
        const enabled = this._editor.getOption(111 /* EditorOption.tabCompletion */) === 'on';
