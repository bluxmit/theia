...
const markdownRenderer_1 = require("../../markdownRenderer/browser/markdownRenderer");
...
let SuggestDetailsWidget = class SuggestDetailsWidget {
    ...
    getLayoutInfo() {
        const lineHeight = this._editor.getOption(108 /* EditorOption.suggestLineHeight */) || this._editor.getOption(44 /* EditorOption.fontInfo */).lineHeight;
