...
const numbers_1 = require("../../../../base/common/numbers");
...
const suggestWidgetStatus_1 = require("./suggestWidgetStatus");
...
const suggestWidgetDetails_1 = require("./suggestWidgetDetails");
const suggestWidgetRenderer_1 = require("./suggestWidgetRenderer");
/**
...
let SuggestWidget = class SuggestWidget {
    ...
    _onListFocus(e) {
        ...
        if (item !== this._focusedItem) {
            ...
            this._currentSuggestionDetails = (0, async_1.createCancelablePromise)((token) => __awaiter(this, void 0, void 0, function* () {
