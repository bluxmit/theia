...
const shiftCommand_1 = require("../../../common/commands/shiftCommand");
const range_1 = require("../../../common/core/range");
const selection_1 = require("../../../common/core/selection");
const languageConfiguration_1 = require("../../../common/languages/languageConfiguration");
const languageConfigurationRegistry_1 = require("../../../common/languages/languageConfigurationRegistry");
const indentUtils = require("../../indentation/browser/indentUtils");
const autoIndent_1 = require("../../../common/languages/autoIndent");
const enterAction_1 = require("../../../common/languages/enterAction");
let MoveLinesCommand = class MoveLinesCommand {
            ...
            if (this._isMovingDown) {
                ...
                if (this.shouldAutoIndent(model, s)) {
                    ...
                    if (movingLineMatchResult !== null) {
                        ...
                        let indentOfMovingLine = (0, autoIndent_1.getGoodIndentForLine)(this._autoIndent, virtualModel, model.getLanguageIdAtPosition(movingLineNumber, 1), s.startLineNumber, indentConverter, this._languageConfigurationService);
                    ...
                    if (ret !== null) {
                        ...
                        let newIndentatOfMovingBlock = (0, autoIndent_1.getGoodIndentForLine)(this._autoIndent, virtualModel, model.getLanguageIdAtPosition(movingLineNumber, 1), s.startLineNumber + 1, indentConverter, this._languageConfigurationService);
                ...
                if (this.shouldAutoIndent(model, s)) {
                    ...
                    if (ret !== null) {
                        ...
                        let indentOfFirstLine = (0, autoIndent_1.getGoodIndentForLine)(this._autoIndent, virtualModel, model.getLanguageIdAtPosition(s.startLineNumber, 1), movingLineNumber, indentConverter, this._languageConfigurationService);
    ...
    parseEnterResult(model, indentConverter, tabSize, line, enter) {
        if (enter) {
            ...
            if (this.trimLeft(movingLineText).indexOf(this.trimLeft(enterPrefix)) >= 0) {
                ...
                let indentMetadataOfMovelingLine = (0, autoIndent_1.getIndentMetadata)(model, line, this._languageConfigurationService);
    ...
    matchEnterRuleMovingDown(model, indentConverter, tabSize, line, futureAboveLineNumber, futureAboveLineText) {
        if (strings.lastNonWhitespaceIndex(futureAboveLineText) >= 0) {
            ...
            let enter = (0, enterAction_1.getEnterAction)(this._autoIndent, model, new range_1.Range(futureAboveLineNumber, maxColumn, futureAboveLineNumber, maxColumn), this._languageConfigurationService);
            ...
            let enter = (0, enterAction_1.getEnterAction)(this._autoIndent, model, new range_1.Range(validPrecedingLine, maxColumn, validPrecedingLine, maxColumn), this._languageConfigurationService);
            return this.parseEnterResult(model, indentConverter, tabSize, line, enter);
        }
    }
