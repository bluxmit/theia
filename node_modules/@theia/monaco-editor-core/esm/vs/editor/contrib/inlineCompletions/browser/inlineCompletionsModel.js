...
const coreCommands_1 = require("../../../browser/coreCommands");
...
const inlineCompletionToGhostText_1 = require("./inlineCompletionToGhostText");
const languageConfigurationRegistry_1 = require("../../../common/languages/languageConfigurationRegistry");
const fixBrackets_1 = require("../../../common/model/bracketPairsTextModelPart/fixBrackets");
...
let InlineCompletionsModel = class InlineCompletionsModel extends lifecycle_1.Disposable {
    ...
    startSessionIfTriggered() {
        const suggestOptions = this.editor.getOption(55 /* EditorOption.inlineSuggest */);
...
class InlineCompletionsSession extends ghostText_1.BaseGhostTextWidgetModel {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (this.updateOperation.value) {
                ...
                if (this.updateOperation.value.triggerKind === languages_1.InlineCompletionTriggerKind.Explicit) {
                    ...
                    yield this.update(languages_1.InlineCompletionTriggerKind.Explicit);
                }
            }
    ...
    get ghostText() {
        ...
        const mode = this.editor.getOptions().get(55 /* EditorOption.inlineSuggest */).mode;
...
function provideInlineCompletions(registry, position, model, context, token = cancellation_1.CancellationToken.None, languageConfigurationService) {
    return __awaiter(this, void 0, void 0, function* () {
        const defaultReplaceRange = getDefaultRange(position, model);
        const providers = registry.all(model);
        const results = yield Promise.all(providers.map((provider) => __awaiter(this, void 0, void 0, function* () {
            const completions = yield Promise.resolve(provider.provideInlineCompletions(model, position, context, token)).catch(errors_1.onUnexpectedExternalError);
            return ({
                completions,
                provider,
                dispose: () => {
