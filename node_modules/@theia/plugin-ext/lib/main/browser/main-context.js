...
const notification_1 = require("../../plugin/notification");
...
function setUpPluginApi(rpc, container) {
    ...
    const notificationExt = new notification_1.NotificationExtImpl(rpc);
    rpc.set(plugin_api_rpc_1.MAIN_RPC_CONTEXT.NOTIFICATION_EXT, notificationExt);
